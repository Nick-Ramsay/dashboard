...
function startSydneyTime() {
    //Daylight Savings Time automation start...
    ...
    var dst_months = (dst_month > 3 && dst_month < 10) ? "true":"false" //Full months of May through September are always DST
    ...
    var dst = (dst_months == "true") || ((first_sunday_april == "true") && (first_sunday_october == "false")) ? 1:0 //If months are May through September OR it is after first Sunday of April and before first Sunday of October
    //Daylight Savings Time automation end...

    var today = new Date();
    var mh = today.getUTCHours();
    var h = today.getUTCHours()+9+dst;
    var m = today.getMinutes();
    var s = today.getSeconds();
